...
| 11 | Release and case study | In progress | TableLint 1.0.0 release candidate: product data-workbench redesign with graphite/violet identity, persistent system-aware light/dark themes, compact shell and score strip, keyboard-accessible Data/Issues/History tabs, synchronized `fx` editor plus inline cell editing, adjacent undo/redo/fix controls, responsive grid, README case study and GitHub Pages workflow; Vitest 104/104 and Playwright 20/20; local `v1.0.0` tag. Production URL remains pending. |
